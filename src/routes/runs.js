...
import { createRun, getRuns, getRun, getUserRuns, removeRun, stats, leaderboard, timeseries } from '../controllers/runsController.js'
...
router.get('/timeseries', authenticateToken, timeseries)
